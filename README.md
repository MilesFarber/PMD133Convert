...
Huge thanks to @capypara, @mandl27, @shitpost_sunkern, @silverdeoxys563, and @tabun_ne for helping with extracting the PMD133 Palette, and @everfree, @taicanium, @sunnyeggsdee, @shrikeshaymin, @marius851000, @oritiefling, and @eriahsylverstone for motivating me to do this.
